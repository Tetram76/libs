...
{$IFNDEF U_HIDE_SYSTEM_API}
function uloc_getDefault; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDefaultDefaultExportName;
procedure uloc_setDefault; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_setDefaultDefaultExportName;
{$ENDIF ~U_HIDE_SYSTEM_API}
function uloc_getLanguage; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getLanguageDefaultExportName;
function uloc_getScript; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getScriptDefaultExportName;
function uloc_getCountry; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getCountryDefaultExportName;
function uloc_getVariant; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getVariantDefaultExportName;
function uloc_getName; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getNameDefaultExportName;
function uloc_canonicalize; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_canonicalizeDefaultExportName;
function uloc_getISO3Language; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getISO3LanguageDefaultExportName;
function uloc_getISO3Country; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getISO3CountryDefaultExportName;
function uloc_getLCID; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getLCIDDefaultExportName;
function uloc_getDisplayLanguage; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayLanguageDefaultExportName;
function uloc_getDisplayScript; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayScriptDefaultExportName;
function uloc_getDisplayCountry; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayCountryDefaultExportName;
function uloc_getDisplayVariant; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayVariantDefaultExportName;
function uloc_getDisplayKeyword; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayKeywordDefaultExportName;
function uloc_getDisplayKeywordValue; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayKeywordValueDefaultExportName;
function uloc_getDisplayName; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getDisplayNameDefaultExportName;
function uloc_getAvailable; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getAvailableDefaultExportName;
function uloc_countAvailable; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_countAvailableDefaultExportName;
function uloc_getISOLanguages; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getISOLanguagesDefaultExportName;
function uloc_getISOCountries; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getISOCountriesDefaultExportName;
function uloc_getParent; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getParentDefaultExportName;
function uloc_getBaseName; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getBaseNameDefaultExportName;
function uloc_openKeywords; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_openKeywordsDefaultExportName;
function uloc_getKeywordValue; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getKeywordValueDefaultExportName;
function uloc_setKeywordValue; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_setKeywordValueDefaultExportName;
function uloc_getCharacterOrientation; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getCharacterOrientationDefaultExportName;
function uloc_getLineOrientation; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getLineOrientationDefaultExportName;
function uloc_acceptLanguageFromHTTP; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_acceptLanguageFromHTTPDefaultExportName;
function uloc_acceptLanguage; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_acceptLanguageDefaultExportName;
function uloc_getLocaleForLCID; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_getLocaleForLCIDDefaultExportName;
function uloc_addLikelySubtags; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_addLikelySubtagsDefaultExportName;
function uloc_minimizeSubtags; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_minimizeSubtagsDefaultExportName;
function uloc_forLanguageTag; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_forLanguageTagDefaultExportName;
function uloc_toLanguageTag; external ICU_DEFAULT_I18N_MODULE_NAME name uloc_toLanguageTagDefaultExportName;
{$ELSE ~ICU_LINKONREQUEST}

function LoadICU: Boolean;
begin
{$IFNDEF U_HIDE_SYSTEM_API}
 	@uloc_getDefault := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDefaultExportName);
 	@uloc_setDefault := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_setDefaultExportName);
{$ENDIF ~U_HIDE_SYSTEM_API}
  @uloc_getLanguage := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getLanguageExportName);
  @uloc_getScript := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getScriptExportName);
  @uloc_getCountry := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getCountryExportName);
  @uloc_getVariant := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getVariantExportName);
  @uloc_getName := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getNameExportName);
  @uloc_canonicalize := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_canonicalizeExportName);
  @uloc_getISO3Language := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getISO3LanguageExportName);
  @uloc_getISO3Country := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getISO3CountryExportName);
  @uloc_getLCID := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getLCIDExportName);
  @uloc_getDisplayLanguage := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayLanguageExportName);
  @uloc_getDisplayScript := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayScriptExportName);
  @uloc_getDisplayCountry := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayCountryExportName);
  @uloc_getDisplayVariant := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayVariantExportName);
  @uloc_getDisplayKeyword := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayKeywordExportName);
  @uloc_getDisplayKeywordValue := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayKeywordValueExportName);
  @uloc_getDisplayName := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getDisplayNameExportName);
  @uloc_getAvailable := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getAvailableExportName);
  @uloc_countAvailable := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_countAvailableExportName);
  @uloc_getISOLanguages := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getISOLanguagesExportName);
  @uloc_getISOCountries := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getISOCountriesExportName);
  @uloc_getParent := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getParentExportName);
  @uloc_getBaseName := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getBaseNameExportName);
  @uloc_openKeywords := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_openKeywordsExportName);
  @uloc_getKeywordValue := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getKeywordValueExportName);
  @uloc_setKeywordValue := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_setKeywordValueExportName);
  @uloc_getCharacterOrientation := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getCharacterOrientationExportName);
  @uloc_getLineOrientation := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getLineOrientationExportName);
  @uloc_acceptLanguageFromHTTP := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_acceptLanguageFromHTTPExportName);
  @uloc_acceptLanguage := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_acceptLanguageExportName);
  @uloc_getLocaleForLCID := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_getLocaleForLCIDExportName);
  @uloc_addLikelySubtags := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_addLikelySubtagsExportName);
  @uloc_minimizeSubtags := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_minimizeSubtagsExportName);
  @uloc_forLanguageTag := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_forLanguageTagExportName);
  @uloc_toLanguageTag := GetModuleSymbol(ICU_I18N_LibraryHandle, uloc_toLanguageTagExportName);
