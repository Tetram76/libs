...
uses
  Windows, SysUtils, Forms, Classes, Controls, PngImageList,
...
procedure TEditProperty.EnumProperty(
{$IFDEF THANY_COMPILER_6_UP}
  const
{$ENDIF}
  Prop: IProperty);
...
begin
  with TPngImageListEditorDlg.Create(nil) do
  begin
