...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvOfficeColorForm.pas 11543 2007-10-25 16:31:32Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvOfficeColorForm.pas $';
    Revision: '$Revision: 11543 $';
    Date: '$Date: 2007-10-25 18:31:32 +0200 (jeu., 25 oct. 2007) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
