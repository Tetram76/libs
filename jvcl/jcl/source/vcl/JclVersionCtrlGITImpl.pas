...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net/svnroot/jcl/trunk/jcl/source/vcl/JclVersionCtrlGITImpl.pas $';
    Revision: '$Revision: 3599 $'; Date: '$Date: 2011-09-03 00:07:50 +0200 (sam., 03 sept. 2011) $';
